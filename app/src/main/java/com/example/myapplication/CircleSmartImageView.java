...
import com.example.myapplication.image.SmartImageView;

/**
 * Created by yangy on 2016/10/12.
 */
public class CircleSmartImageView extends SmartImageView {
    ...
    public CircleSmartImageView(Context context, AttributeSet attrs, int defStyle) {
